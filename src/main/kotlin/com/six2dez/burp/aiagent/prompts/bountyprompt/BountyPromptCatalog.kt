...
object BountyPromptCatalog {
    val curatedPromptIds: Set<String> =
        linkedSetOf(
    ...
    private val categoryById: Map<String, BountyPromptCategory> =
        mapOf(
    ...
    fun categoryFor(id: String): BountyPromptCategory = categoryById[id] ?: BountyPromptCategory.ADVISORY
