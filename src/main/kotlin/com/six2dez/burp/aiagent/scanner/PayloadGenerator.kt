...
class PayloadGenerator {
    ...
    private val staticPayloads: Map<VulnClass, List<Payload>> =
        mapOf(
            // ==================== SQL INJECTION ====================
            VulnClass.SQLI to
                listOf(
            ...
            VulnClass.XSS_DOM to
                listOf(
                    ...
                    Payload(
                        "#<script>alert('DOM-XSS-BURP-AI')</script>",
                        VulnClass.XSS_DOM,
                        DetectionMethod.REFLECTION,
                        PayloadRisk.SAFE,
                        "Hash injection",
            ...
            VulnClass.HEADER_INJECTION to
                listOf(
                    Payload(
                        "value\r\nX-Injected: burp-ai-test",
                        VulnClass.HEADER_INJECTION,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "X-Injected header",
                    ),
                    Payload(
                        "value%0d%0aX-Injected:%20burp-ai-test",
                        VulnClass.HEADER_INJECTION,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "Encoded CRLF",
            ...
            VulnClass.CRLF_INJECTION to
                listOf(
                    Payload(
                        "%0d%0aSet-Cookie:%20burp-ai-test=true",
            ...
            // ==================== JWT WEAKNESS ====================
            VulnClass.JWT_WEAKNESS to
                listOf(
                    Payload(
                        "eyJhbGciOiJub25lIiwidHlwIjoiSldUIn0",
                        VulnClass.JWT_WEAKNESS,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "alg:none accepted",
                    ),
            ...
            // ==================== LOG INJECTION ====================
            VulnClass.LOG_INJECTION to
                listOf(
                    Payload(
                        "test\nINFO: Injected log entry",
                        VulnClass.LOG_INJECTION,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "Log injection",
                    ),
            ...
            VulnClass.HOST_HEADER_INJECTION to
                listOf(
                    Payload(
                        "evil-burp-ai-test.com",
                        VulnClass.HOST_HEADER_INJECTION,
                        DetectionMethod.REFLECTION,
                        PayloadRisk.SAFE,
                        "evil-burp-ai-test.com in response",
                    ),
                    Payload(
                        "localhost",
                        VulnClass.HOST_HEADER_INJECTION,
            ...
            VulnClass.EMAIL_HEADER_INJECTION to
                listOf(
                    Payload(
            ...
            VulnClass.OAUTH_MISCONFIGURATION to
                listOf(
                    Payload(
                        "https://evil-burp-ai.com/callback",
                    ...
                    Payload(
                        "https://legitimate.com.evil-burp-ai.com",
                        VulnClass.OAUTH_MISCONFIGURATION,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "Subdomain bypass",
                    ...
                    Payload(
                        "https://legitimate.com%40evil-burp-ai.com",
                        VulnClass.OAUTH_MISCONFIGURATION,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "Encoded @ bypass",
            ...
            VulnClass.CACHE_POISONING to
                listOf(
                    ...
                    Payload(
                        "evil-burp-ai-cache.com",
                        VulnClass.CACHE_POISONING,
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "Host reflected in cached response",
                    ),
                ),
            // ==================== CACHE DECEPTION ====================
            VulnClass.CACHE_DECEPTION to
                listOf(
                    ...
                    Payload(
                        ...
                        DetectionMethod.CONTENT_BASED,
                        PayloadRisk.SAFE,
                        "Sensitive data with static extension",
                    ),
                    Payload(
                        "/..%2fstatic.js",
                        VulnClass.CACHE_DECEPTION,
     ...
     */
    fun getQuickPayloads(
        vulnClass: VulnClass,
        maxRisk: PayloadRisk = PayloadRisk.SAFE,
    ): List<Payload> =
        staticPayloads[vulnClass]
     ...
     */
    fun getAllPayloads(vulnClass: VulnClass): List<Payload> = staticPayloads[vulnClass] ?: emptyList()
     ...
     */
    private fun generateIdorPayloads(
        originalValue: String,
        maxPayloads: Int,
    ): List<Payload> {
     ...
     */
    private fun generateSqliPayloads(
        originalValue: String,
        maxPayloads: Int,
    ): List<Payload> {
        val payloads = mutableListOf<Payload>()
